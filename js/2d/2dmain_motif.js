/* globals $, URI, Table2DMotifBuilder, TableDirector */
...
// ////////////////////////////
  ...
  function writeAjaxPage () {
    $('#wrapper').empty()
    $.ajax({
      url: './json/json_2dmotif_trimmed.php?row=' + uriParam.row + '&col=' + uriParam.col,
      dataType: 'json'
    }).done(function (data) {
      var builder = new Table2DMotifBuilder(data, title)
